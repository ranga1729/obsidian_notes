...
Lambda function only process a request for only 15 mins. It's not good for model training or something. Good for event driven applications like backend API processing. 
