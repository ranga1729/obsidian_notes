...
We reviewed the back end API of the select order history, 
Got some feedbacks, I'm currently working on them. 

today I'm planning to debug the order form asynchronous issue and find out exactly where the delay is happening. I have applied this new approach only in the nutrition page, for testing purposes, So have to apply the new changes to the other pages as well.

If Senesh is done with the designs of the order history modal, I can work on it too. 

Remove the migration. 
delete the snapshot. do the migration again.

foodBoxOrderService.cs
*****
```C#
using FFF.Domain;
            ...
            var order = await _dataContext.FoodBoxOrders
                ...
                .Select(o => new FoodBoxOrderDetailsDto
                {
                    ...
                    Credits = o.Transactions
                        ...
                        .Where(tl => tl.LedgerCode.Code == LedgerCodes.CustomerCredit).Sum(t => t.Amount),
                    Tokens = o.Transactions
                        .SelectMany(t => t.TransactionLines)
                        .Where(tl => tl.LedgerCode.Code == LedgerCodes.TokenUtilization).Sum(t => t.Amount),
                    OrderPlacementDate = o.CreatedDateUtc,
                    ...
                    DeliveryDays = o.DeliveryDays.Select(d => new FoodBoxDeliveryDayDetailsDto
                    {
                        ...
                        Discount = d.Discount,
                        Items = d.Items.Select(i => new FoodBoxDeliveryItemDetailsDto
                        {
                            MenuItemId = i.FoodBoxMenuItemId,
                            ItemId = i.FoodBoxMealVariationId ?? i.FoodBoxExtraId,
                            Type = i.Type,
                            Quantity = i.Quantity,
                            DietaryPreferenceIds = i.FoodBoxDeliveryDayItemLog.DietaryPreferenceIds != null ?
                            //comma separated ids
                            new List<string> { i.FoodBoxDeliveryDayItemLog.DietaryPreferenceIds } :
                            ...
                            PortionSizeId = i.FoodBoxDeliveryDayItemLog.PortionSizeId ?? i.FoodBoxMealVariation.PortionSizeId,
                            MenuItemName = i.FoodBoxDeliveryDayItemLog.FoodBoxMenuItemName ?? i.FoodBoxMenuItem.Name
                        }).ToList()
                    })
                    .OrderBy(d => d.Date)
                    .ToList(),
...
namespace FFF.Domain.Dtos.Business.FoodBox.Delivery
{
    public class FoodBoxDeliveryItemDetailsDto
    {
        public string MenuItemId { get; set; }
        public string MenuItemName { get; set; }
        public string MenuItemSectionTypeId { get; set; }
        public string MenuItemThumbnailUrl { get; set; }
        public FoodBoxMenuItemType Type { get; set; }
        public string ItemId { get; set; }
        public int Quantity { get; set; }
        public string ThumbnailUrl { get; set; }
        public string PortionSizeId { get; set; }
        public List<string> DietaryPreferenceIds { get; set; }
...
namespace FFF.Domain.Dtos.Business.FoodBox.Order
{
    public class FoodBoxOrderDetailsDto
    {
        public string Id { get; set; }
        public string UserId { get; set; }
        public int OrderNo { get; set; }
        public string FormattedOrderNo
        {
            get
            {
                return string.Format("S{0}", OrderNo.ToString("D5"));
            }
        }
        ...
        public List<FoodBoxDeliveryDayDetailsDto> DeliveryDays { get; set; }
        public DateTime OrderUpdateCutoffDateTime { get; set; }
        public string PostcodeGroupId { get; set; }
...
```
****
FoodBoxDeliveryDayItem
```c#
using FFF.Domain.Entities.Base;
using FFF.Domain.Enums;
using System.ComponentModel.DataAnnotations;
using System.ComponentModel.DataAnnotations.Schema;

namespace FFF.Domain.Entities.Business.FoodBox
{
    public class FoodBoxDeliveryDayItem : BaseEntity
    {
        [Required]
        [ForeignKey("DeliveryDay")]
        public string DeliveryDayId { get; set; }
        public FoodBoxMenuItemType Type { get; set; }
        [ForeignKey("FoodBoxMenuItem")]
        public string FoodBoxMenuItemId { get; set; }
        [ForeignKey("FoodBoxMealVariation")]
        public string FoodBoxMealVariationId { get; set; }
        [ForeignKey("FoodBoxExtra")]
        public string FoodBoxExtraId { get; set; }
        public int Quantity { get; set; }
        public decimal UnitPrice { get; set; }


        public virtual FoodBoxDeliveryDay DeliveryDay { get; set; }
        public virtual FoodBoxMealVariation FoodBoxMealVariation { get; set; }
        public virtual FoodBoxExtra FoodBoxExtra { get; set; }
        public virtual FoodBoxMenuItem FoodBoxMenuItem { get; set; }
        public virtual FoodBoxDeliveryDayItemLog FoodBoxDeliveryDayItemLog { get; set; }
    }
}
```
****
FoodBoxDeliveryDayItemLog
```c#
using FFF.Domain.Entities.Base;
using System.ComponentModel.DataAnnotations.Schema;
...
namespace FFF.Domain.Entities.Business.FoodBox
{
    public class FoodBoxDeliveryDayItemLog : BaseEntity
    {
        [ForeignKey("FoodBoxDeliveryDayItem")]
        public string FoodBoxDeliveryDayItemId { get; set; }
        public string FoodBoxMenuItemName { get; set; }
        public string PortionSizeId { get; set; }
        public string DietaryPreferenceIds { get; set; }
        public double Calories { get; set; }
        public double ProteinInGrams { get; set; }
        public double CarbsInGrams { get; set; }
        public double FatInGrams { get; set; }
        public int Quantity { get; set; }
        public virtual FoodBoxDeliveryDayItem FoodBoxDeliveryDayItem { get; set; }
    }
}
```
****
FoodBoxOrderController
```c#
[HttpGet("{id}/Details")]
[AllowAnonymous]
public async Task<FoodBoxOrderDetailsDto> GetDetailsById(string id)
{
    var result = await _foodBoxOrderService.GetDetailsByIdAsync(id);
    return result;
}
```

Added_ForeignKey_From_FoodBoxDeliveryDayItems_To_FoodBoxDeliveryDayItemLogs
...
namespace FFF.Data.Migrations
{
    public partial class Added_ForeignKey_From_FoodBoxDeliveryDayItems_To_FoodBoxDeliveryDayItemLogs : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateIndex(
                name: "IX_FoodBoxDeliveryDayItemLogs_FoodBoxDeliveryDayItemId",
                table: "FoodBoxDeliveryDayItemLogs",
                column: "FoodBoxDeliveryDayItemId",
                unique: true);

            migrationBuilder.AddForeignKey(
                name: "FK_FoodBoxDeliveryDayItemLogs_FoodBoxDeliveryDayItems_FoodBoxD~",
                table: "FoodBoxDeliveryDayItemLogs",
                column: "FoodBoxDeliveryDayItemId",
                principalTable: "FoodBoxDeliveryDayItems",
                principalColumn: "Id");
        }
