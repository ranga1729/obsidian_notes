Worked on the front end part of the select order history, It's done, but i need to get feedbacks from Nuwan about the Component structure and also there are few thing I need to clarify about  back end part of the order history and background-jobs.

****
https://gitlab.calcey.com/calceytechnologies/fff/fff-web/-/merge_requests/1302/diffs

Order History task:
daily delivery address + token (pending)
test current changes.
commit other changes
put a PR

tell Nusrath to check the merged PRs.
resolve the merger conflicts arised in other PRs.

Finalize the back end of the select order history. 
Put a release. Then tell UI/UX to work on designs. 

Next-menu available date task can be hand over to UI/UX

create a separate component for the select order history modal including right and left sides both in a one component. 
****
default: 

*****
QA list,
1. Select discount code column  ////
...
2. Select next menu available date in the customer portal ////**
Not approved - (https://gitlab.calcey.com/calceytechnologies/fff/fff-web/-/merge_requests/1319)
	Merge conflicts solved
Not approved - (https://gitlab.calcey.com/calceytechnologies/fff/fff-api/-/merge_requests/1543)
	**Merge conflicts**

Send this to Induni,
Let her to make a branch on this one, and let her complete the task.
Then merge her branch in to the Foodbox.

3. Extra items expiry input field changed to number type ////***
Not approved - (https://gitlab.calcey.com/calceytechnologies/fff/fff-web/-/merge_requests/1311)

4. Sort recipes in a custom order /////**
Not approved - (https://gitlab.calcey.com/calceytechnologies/fff/fff-web/-/merge_requests/1302)

5. Add a button in menu items to navigate & filter meal-variations.  ////
Approved & merged - (https://gitlab.calcey.com/calceytechnologies/fff/fff-web/-/merge_requests/1300)

6. Menu item to be searched by the code ////
Approved & merged - https://gitlab.calcey.com/calceytechnologies/fff/fff-api/-/merge_requests/1535
Only back end 


*****
**Select Order History**
API commit:  https://gitlab.calcey.com/calceytechnologies/fff/fff-api/-/commits/select-order-history 
API branch name: select-order-history
                ...
                .Select(o => new FoodBoxOrderDetailsDto
                {
                    ...
                    DeliveryDays = o.DeliveryDays.Select(d => new FoodBoxDeliveryDayDetailsDto
                    {
                        ...
                        Items = d.Items.Select(i => new FoodBoxDeliveryItemDetailsDto
                        {
                            ...
                            //null reference issue is here 
                            DietaryPreferenceIds = i.FoodBoxDeliveryDayItemLog.DietaryPreferenceIds != null ?
                                i.FoodBoxDeliveryDayItemLog.DietaryPreferenceIds
                                .Split(new[] { ',' })
                                .ToList() :
